...
export default function SignInPage() {
  const [formState, formAction]: [FormState, (data: Record<string, any>) => Promise<void>, boolean] = useFormState(
    signInAction,
    {}
  );
        ...
        <div className="card-body p-6">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <p className="text-center text-xs">
              ...
              <Link href="/reset-password" className="ml-2 font-bold text-primary-content hover:underline">
                {NOUNS.CLICK_HERE}
              </Link>
            </p>
          ...
          <p className="mt-4 text-center text-xs">
            {NOUNS.SIGNUPTEXT}
            <Link href="/register" className="ml-2 font-bold text-primary-content hover:underline">
              {NOUNS.SIGNUPBUTTON}
            </Link>
          </p>
        </div>
